					...
					<div className="container">
						<div className="hero-sub__content">
							...
							<p className="p--large p--reversed">
								Infinite Red has been designing, building and shipping apps remotely for over 10 years.
								Our team has so many accreditations and skills, we couldn’t possibly list them all. You
								might recognize quite a few faces from popular React Native blog posts, to JavaScript
								conferences, podcasts, and the Open Source community. Plus, we’re a pretty fun team to
								work with (though our opinion might be biased).
							</p>
						</div>
					</div>
				</div>
					...
					<div className="container">
						<div className="col-icon-3 w-row">
							<div className="col-icon__col w-col w-col-4">
								...
								<p>
									We over-communicate. At every step of the process you will know what to expect,
									where your investment is going, and how to make it go farther. We treat you like a
				...
				<div className="footer">
					<div className="footer__container">
						<div className="footer__nav">
							...
							<a href="company.html" aria-current="page" className="footer__nav__link w--current">
								Company
							</a>
