			...
			<div>
				...
				>
					<div className="nav__container">
						<a href="index.html" aria-current="page" className="nav__brand w-inline-block w--current">
				...
				<div className="cta-capabilities">
					<div className="container">
						<div className="cta__intro">
							...
							<p className="p--large">
								We only have senior software engineers and designers. They have been helping businesses
								like yours for over ten years. Our thorough network and knowledge lets us build the
								right solution. We take pride in reliable, reusable, and readable works. <br />
				...
				<div className="cta-img cta-img--react">
					<div className="container">
						<div className="cta__intro">
							...
							<p className="p--large p--reversed">
								When it comes to mobile and web technologies, we are second to none. Our software
								engineers have worked with React.JS and React Native to build web and mobile apps for
								over five years. We maintain some of the most popular React/React Native open source
								software. We also host the USA’s only React Native conference.
								<br />
									...
									<div className="client-testimonial__slide-container">
										<div className="client-testimonial__collection-wrapper w-dyn-list">
											<div role="list" className="client-testimonial__collection w-dyn-items">
												...
												>
													<p className="p--quote">
														“The team at Infinite Red brought me from an idea, to reality.
														They worked with me and added a unique perspective to my project
														and created something beyond what I had imagined. They took the
														time to listen to what I needed and quickly made it something
														beautiful and cohesive! My experience with this design team was
														unparalleled!”
													</p>
													<div
														style={{ backgroundImage: 'none' }}
											...
											<div role="list" className="client-testimonial__collection w-dyn-items">
												...
												>
													<p className="p--quote">
														...
														trusted partner with deep development expertise, excellent
														product vision, and the muscle to get the job done."
													</p>
													<div
														style={{ backgroundImage: 'none' }}
														className="client-testimonial__img"
									...
									<div className="client-testimonial__slide-container">
										<div className="client-testimonial__collection-wrapper w-dyn-list">
											<div role="list" className="client-testimonial__collection w-dyn-items">
												...
												>
													<p className="p--quote">
														"They took our prototype and built it into a working production
														MVP, and quickly adapted to changes as we did customer
														development."
													</p>
													<div
														style={{
											...
											<div role="list" className="client-testimonial__collection w-dyn-items">
												...
												>
													<p className="p--quote">
														...
														building the app. They were always available, always
					...
					<div className="footer__container">
						<div className="footer__nav">
							<a
								href="index.html"
								aria-current="page"
								className="footer__nav__brand w-inline-block w--current"
							>
								<img
