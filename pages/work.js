	...
	render() {
		return (
			<div>
				...
				{/* Mirrored from infinite.red/work by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 23 Dec 2020 11:36:29 GMT */}
				<meta charSet="utf-8" />
				<title>Our Work - Infinite Red</title>
				<meta
					content="We design & build extraordinary native mobile apps & websites. React Native, React.js, Elixir/Phoenix, Rails. Fully remote throughout the U.S."
					name="description"
				/>
				<meta content="Our Work - Infinite Red" property="og:title" />
				<meta
					content="We design & build extraordinary native mobile apps & websites. React Native, React.js, Elixir/Phoenix, Rails. Fully remote throughout the U.S."
				...
				<meta
					...
					property="og:image"
				/>
				<meta content="Our Work - Infinite Red" property="twitter:title" />
				<meta
					content="We design & build extraordinary native mobile apps & websites. React Native, React.js, Elixir/Phoenix, Rails. Fully remote throughout the U.S."
					...
					<div className="container">
						<div className="hero-sub__content">
							...
							<p className="p--large p--reversed">
								Our company has teams working on multiple projects across all domains. &nbsp;Some of us
								are assisting external groups, and some of us are leading client ideas through design
								and development to a finished product.
							</p>
						</div>
					</div>
				</div>
				<div className="projects">
					<div className="section-intro-symbol">
						...
						<p className="p--large p--large__spacer--24">
							Out of the hundreds of clients we've worked with, we've captured a few case studies to
							share. &nbsp;Would you like to be our next one?
						</p>
								...
								>
									...
									>
										<div
											style={{
												backgroundImage:
													'url(_https_/assets.website-files.com/5e696c156810060ef59d768e/5f8915a4c60fdd56be9c9ca0_thumb-sellebrate.html)',
											}}
								...
								>
									...
									>
										<div
											style={{
												backgroundImage:
													'url(_https_/assets.website-files.com/5e696c156810060ef59d768e/5ebd89a45fff683d750397ae_tile-bukowskis.html)',
											}}
											className="work-list__project__card__img"
										/>
										<div className="work-list__project__card__info">
								...
								>
									...
									>
										<div
											style={{
												backgroundImage:
													'url(_https_/assets.website-files.com/5e696c156810060ef59d768e/5ebd8989e602c74456cc9237_tile-addis.html)',
											}}
											className="work-list__project__card__img"
										/>
										<div className="work-list__project__card__info">
				...
				<div className="footer">
					<div className="footer__container">
						<div className="footer__nav">
							...
							<a href="work.html" aria-current="page" className="footer__nav__link w--current">
								Work
							</a>
				...
				{/*[if lte IE 9]><![endif]*/}
				{/* Mirrored from infinite.red/work by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 23 Dec 2020 11:36:33 GMT */}
			</div>
		);
	}
}
